...
function newTask() {
    ...
    // clear element
    todoElement.value = "";
    // render out the list (call the renderTasks function)
    renderTasks(tasks);
...
document.querySelector("#submitTask").addEventListener("click", newTask);//pulls the button from html so the js can look at it as well. find submitTask button, listen to if it gets clicked, call the newTask function.